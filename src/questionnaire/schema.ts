...
export const routineSchema = z.object({
  ...
  kitchenAccessDaytime: z.enum(["None", "Microwave", "Full kitchen"], {
    required_error: "Kitchen access is required",
  }),
  mealPrepWillingness: z.enum(["None", "Light 10-15 mins", "Batch cook 1-2x week"], {
    required_error: "Meal prep willingness is required",
  }),
})
...
export const trainingSchema = z.object({
  ...
  trainingTimeOfDay: z.enum(["Morning", "Lunch", "Evening", "Varies"], {
    required_error: "Training time is required",
  }),
  dailySteps: z.enum(["<5k", "5-8k", "8-12k", "12k+"], {
    required_error: "Daily steps is required",
  }),
})
...
export const preferencesSchema = z.object({
  dietStyle: z.enum(["Omnivore", "Pescatarian", "Vegetarian", "Vegan", "Other"], {
    required_error: "Diet style is required",
  }),
  ...
  biggestObstacle: z.enum(["Time", "Stress", "Cravings", "Travel", "Social eating", "Night eating", "Inconsistent schedule"], {
    required_error: "Biggest obstacle is required",
  }),
